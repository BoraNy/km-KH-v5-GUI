...
def LiveSpeechToText():
    ...
    for speech in speech_recognition:
        startSpeechDecoderTimer = time()
        speech = str(speech)
        print('Full conversion: ', time() - startSpeechDecoderTimer)

        startRespondTimer = time()
        # Automatic Response
        respond = get_response(speech)
        print('Robot respond: ', time() - startRespondTimer)

        ### Output Audio Respond
        # system(f'play audio/{respond}.wav')
...
def UserInterface():
    class Ui_MainWindow(object):
        ...
        def setupUi(self, MainWindow):
            ...
            self.ExitPushButton.setGeometry(QtCore.QRect(380, 194, 89, 41))
            self.ExitPushButton.setObjectName("ExitPushButton")

            self.ResetPushButton = QtWidgets.QPushButton(MainWindow)
            self.ResetPushButton.setGeometry(QtCore.QRect(248, 194, 121, 41))
            self.ResetPushButton.setObjectName("ResetPushButton")

            self.KhmerTextReceivedFromSTT = QtWidgets.QLineEdit(MainWindow)
            self.KhmerTextReceivedFromSTT.setGeometry(QtCore.QRect(20, 40, 441, 41))
            ...
            self.KhmerInputInfo.setGeometry(QtCore.QRect(20, 0, 241, 41))
            ...
            self.KhmerRespondFromInputInfo.setGeometry(QtCore.QRect(20, 80, 221, 51))
            self.KhmerRespondFromInputInfo.setObjectName("KhmerRespondFromInputInfo")

            self.KhmerTextRespondFromRobot = QtWidgets.QLineEdit(MainWindow)
            self.KhmerTextRespondFromRobot.setGeometry(QtCore.QRect(20, 130, 441, 41))
            ...
            self.BuildInfo.setGeometry(QtCore.QRect(20, 190, 180, 41))
            self.BuildInfo.setObjectName("BuildInfo")

            self.line = QtWidgets.QFrame(MainWindow)
            self.line.setGeometry(QtCore.QRect(20, 25, 441, 21))
            self.line.setFrameShape(QtWidgets.QFrame.HLine)
            self.line.setFrameShadow(QtWidgets.QFrame.Sunken)
            self.line.setObjectName("line")

            self.line_2 = QtWidgets.QFrame(MainWindow)
            self.line_2.setGeometry(QtCore.QRect(20, 110, 441, 21))
        ...
        def retranslateUi(self, MainWindow):
            ...
            MainWindow.setWindowTitle(_translate("MainWindow", "ប្រព័ន្ធទទួលស្គាល់សម្លេងស្វ័យប្រវត្តិជាភាសាខ្មែរ"))
            ...
            self.BuildInfo.setText(_translate("MainWindow", "កំណែ ០.៣១"))
